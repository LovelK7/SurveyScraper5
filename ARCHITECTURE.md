...
| [2.1d](#part-21d) fotografije ulaza | [**B8**](#b8); processing rides with [**B11**](#b11) (M6) |
...
| <a name="b8"></a>**B8** | `cavedossier photos match-queued/check-flag` | staged photos ↔ SB | new entrance photos were staged |
