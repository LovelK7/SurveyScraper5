...
| Tool | Role | Run when |
|---|---|---|
| [`READ ME FIRST - process a survey.txt`](../../../prod/csx_templates/READ%20ME%20FIRST%20-%20process%20a%20survey.txt) (copied into the TDX folder) | plain-language, jargon-free operator checklist for the whole routine (drag-drop, `_pp`/`_lt` endings, black-window messages) | the human starting point — read before running anything |
