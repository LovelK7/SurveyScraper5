...
| 2.2a — SB (master registry) | **M1 ✅ DONE** (read-only, live SB v3.0). Live workbook now **1438 rows**; write-back still M6 — [mechanics](stages/6P-predaja/docs/sb-write-back-design.md) + [what delivery writes](stages/6P-predaja/docs/m6-delivery-design.md) both designed, neither built |
