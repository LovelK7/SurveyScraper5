...
| **SB / Speleo baza** | The society's cave registry — live Excel workbook `!Speleo_baza_SUE_v3.0.xlsm` (macro-heavy, shared, on Drive). Rows = every cave discovered + caves to be explored | Part 2.2: source of primary data (coordinates, year), target of write-back (dimensions) |
