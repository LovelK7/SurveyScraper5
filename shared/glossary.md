...
| **Izjava (za katastar)** | Author statement/consent file (`Izjava_<name>.pdf`), one per drawing/photo author, in its own Drive dir (`!!Izjave za katastar RH/`) | Dossier gating: missing statement per author = hard blocker |
